...
public class TodoListRepository : ITodoListRepository
{
    ...
    public async Task<TodoListModel> CreateAsync(string userId,  TodoListCreateModel model)
    {
    ...
    public async Task<PaginatedModel<TodoListModel>?> GetAllAsync(string userId, int pageNum, int pageSize)
    {
    ...
    public async Task<PaginatedModel<TodoListPreviewModel>> GetAllPreviewAsync(string userId, int pageNum, int pageSize)
    {
        var query = this.context.TodoLists
            .Where(t => t.Members.Any(m => m.UserId == userId));
    ...
    public async Task<TodoListModel?> GetAsync(string userId, int id)
    {
    ...
    public async Task<TodoListModel?> PatchAsync(string userId, int id, JsonPatchDocument<TodoListUpdateModel> patchDoc)
    {
        var entity = await this.context.TodoListUsers
    ...
    public async Task<bool> UpdateAsync(string userId, int id, TodoListCreateModel model)
    {
        var entity = await this.context.TodoListUsers
